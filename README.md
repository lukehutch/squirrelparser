...
A fast, robust **PEG packrat parser** that handles all forms of left recursion and provides optimal error recovery, all while maintaining **linear-time performance** O(n·|G|). This makes the squirrel parser the fastest and the most robust parser in existence.
...
For the full derivation of the algorithm, see [the paper](paper/squirrel_parser.tex):
