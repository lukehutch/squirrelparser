// _acc111.dart -- do the brief's two named cases survive I66 (lookahead site) and I67 (I54 narrowed to the tie)?
//
...
void main() {
  ...
  for (final (name, s, want) in cases) {
    ...
    print('  m111   cost ${b.recoverCost(s)}   '
