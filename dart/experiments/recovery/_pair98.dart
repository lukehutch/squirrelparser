// _pair98.dart -- m92 vs m98 (the swept repetition) interleaved within each case.
//
...
//
// Usage: dart run _pair98.dart [reps]
...
void main(List<String> argv) {
  ...
  final b = <String, MatchResult? Function(String)>{
    for (final c in corpora)
      c.name: g98.SuperDot3(rules: rulesOf[c.name]!, topRuleName: c.top).recover
  };
  ...
  print('  m98  (sweep: one visit per end)   ${mb.toStringAsFixed(0)} ms'
