// m59's battery throughput, measured as an adjacent pair with m53 in one
...
import 'm60.dart' as a;
import 'm53.dart' as b;
...
void main() {
  ...
  for (final (name, recover) in [
    ('m59', a.SuperDot3(rules: rules, topRuleName: 'JSON').recover),
    ('m53', b.SuperDot3(rules: rules, topRuleName: 'JSON').recover),
  ]) {
