...
int nWays = 0, nPr = 0, nPrIn = 0, nPr2 = 0, nPrBig = 0;
int nClose = 0, nWrap = 0, nTerm = 0, nTermClean = 0;
int nSeqNextIn = 0, nSeqNextOut = 0, nSeqSlots = 0;
int nFirstIn = 0, nFirstOut = 0, nRepAll = 0;
...
class Squirrel {
  ...
  List<_Way> _seq(Seq c, int pos) {
    ...
    for (var i = 0; i < c.subClauses.length; i++) {
      ...
      nSeqSlots++;
      nSeqNextIn += next.length;
      if (next.isEmpty) {
        whole = false;
        break;
      }
      cur = _prune(next);
      nSeqNextOut += cur.length;
    }
