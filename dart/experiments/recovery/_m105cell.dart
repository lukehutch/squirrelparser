// _m105cell.dart -- m105 counting how much of a repair round only
// re-derives the pure parse. Generated by mkprof3.py. NOT an engine.
//
...
/// Counters, read by _cell105.dart. Repair rounds only (budget > 0).
int cellsRun = 0, cellsPureOnly = 0, cellsEmpty = 0, cellsHit = 0;
int offersFree = 0, offersPaid = 0;
  ...
  _Ways _fix(Map<Clause, List<_Cell?>> memo, Clause c, int pos,
    ...
    if (_budget > 0) {
      ...
      if (cell.ways == null) {
        ...
        var paid = false;
        for (var e = cell.ways; e != null; e = e.next) {
          if (e.cost > 0) paid = true;
        }
        if (!paid) cellsPureOnly++;
      }
    }
    cell
      ..inPath = false
