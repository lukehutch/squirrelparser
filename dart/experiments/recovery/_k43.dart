// Scratch: how does each engine scale in K? m43 wraps every terminal in a junk
// cell, so a terminal's end-map grows with the budget where m42's did not. This
...
void main(List<String> args) {
  ...
  int Function(String) make() => switch (name) {
        ...
        'm42' => g42.SuperDot3(rules: rules, topRuleName: 'JSON').recoverCost,
        _ => g43.SuperDot3(rules: rules, topRuleName: 'JSON').recoverCost,
      };
  final d = doc(16);
  final out = <String>[];
