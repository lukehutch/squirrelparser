...
import 'r8.dart' as z8;
import '_w1.dart' as zw1;
import '_w2.dart' as zw2;
import '_w3.dart' as zw3;
import '_w4.dart' as zw4;
import '_w5.dart' as zw5;
import '_w6.dart' as zw6;
import '_w7.dart' as zw7;
...
typedef _Mk = MatchResult Function(String) Function(Map<String, Clause>, String);
final _extra = <String, _Mk>{
  'r8': (r, t) => z8.Squirrel(rules: r, topRuleName: t).recover,
  'w1': (r, t) => zw1.Squirrel(rules: r, topRuleName: t).recover,
  'w2': (r, t) => zw2.Squirrel(rules: r, topRuleName: t).recover,
  'w3': (r, t) => zw3.Squirrel(rules: r, topRuleName: t).recover,
  'w4': (r, t) => zw4.Squirrel(rules: r, topRuleName: t).recover,
  'w5': (r, t) => zw5.Squirrel(rules: r, topRuleName: t).recover,
  'w6': (r, t) => zw6.Squirrel(rules: r, topRuleName: t).recover,
  'w7': (r, t) => zw7.Squirrel(rules: r, topRuleName: t).recover,
};

/// Scratch resolver: the tracked table plus the untracked variants.
MatchResult? Function(String) Function(Map<String, Clause>, String)? resolveX(
    String name) {
  final e = _extra[name];
  if (e != null) return (r, t) => e(r, t);
  return resolve(name);
}
...
void main(List<String> argv) {
  ...
  final name = argv[0];
  final build = _extra[name] ?? resolve(name);
  if (build == null) {
    print('$name UNKNOWN');
    return;
  }
