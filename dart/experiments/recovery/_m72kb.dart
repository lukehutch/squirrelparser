...
class SuperDot3 {
  ...
  static int nCall = 0, nProbe = 0, nShift = 0, nAppend = 0, nInterior = 0;
  static int nUpdate = 0, nLenSum = 0, nLenMax = 0;

  bool _keepBest(List<int> out, int key, int cost, int reg, int why) {
    nCall++;
    nLenSum += out.length >> 2;
    if (out.length >> 2 > nLenMax) nLenMax = out.length >> 2;
