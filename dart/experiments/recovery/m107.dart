// m107.dart -- WAVE counterpart of m105 (span). Exists only to prove that the
// answer does not depend on the order the ways sit in the list.
// Ordering under test: echo ranks BELOW doubt -- WAVE counterpart of m102.
//
      ...
      for (final e in frontier) {
        ...
        for (var x = _element(r.subClause, e); x != null; x = x.next) {
          ...
          if (!_better(cost, w.net + x.net, w.got + x.got,
              w.blind + x.blind, w.site + x.site,
            w.cost > 0 ? w.doubt : x.doubt,
              x.cost > 0 ? x.echo : w.echo, reach[x.end])) {
            continue;
          }
