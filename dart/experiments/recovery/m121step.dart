// m121step.dart -- m121 with the doubling schedule replaced by step-by-one.
// A schedule-INDEPENDENT engine must score identically both ways;
// a schedule-dependent one must not. Probe only, never an engine.
...
class SuperDot3 {
  ...
  MatchResult recover(String s) {
    ...
    for (_budget = 0; _budget <= cap; _budget = _budget + 1) {
      _mc.clear();
      _me.clear();
