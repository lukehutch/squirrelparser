  ...
  List<_Way> _terminal(Clause c, int pos) {
    ...
    if (c is Str) {
      for (var k = c.text.length - 1; k >= 1; k--) {
        ...
        // The input must supply MORE of the literal than the repair does.
        // Below that the characters read are a coincidence the repair is
        // building a keyword around, not a keyword with a character lost.
        if (c.text.length - k >= k) continue;
