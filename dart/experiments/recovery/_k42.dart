// Scratch: how does each engine scale in K? m42 wraps every terminal in a junk
// cell, so a terminal's end-map grows with the budget where m41's did not. This
...
void main(List<String> args) {
  ...
  int Function(String) make() => switch (name) {
        ...
        'm41' => g41.SuperDot3(rules: rules, topRuleName: 'JSON').recoverCost,
        _ => g42.SuperDot3(rules: rules, topRuleName: 'JSON').recoverCost,
      };
  final d = doc(16);
  final out = <String>[];
