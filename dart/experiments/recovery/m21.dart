...
class SuperDot3 {
  ...
  /// ONE memo, holding the budget each entry was computed at alongside the
  /// entry itself: A3 makes the budget a filter rather than part of the key, so
  /// an entry computed at a larger budget still answers a smaller one.
  final Map<int, (int, Map<int, int>)> _memo = {};
  MatchResult? _clean;
