// _pair100.dart -- m98 vs m105 (the swept repetition) interleaved within each case.
//
...
void main(List<String> argv) {
  ...
  print('  m105  (sweep: one visit per end)   ${mb.toStringAsFixed(0)} ms'
