// _m105first.dart -- m105 counting the work `_first` discards.
// Generated by mkprof4.py. NOT an engine: the counters are global.
//
...
/// Counters, read by _first105.dart.
int firstCalls = 0, firstRepairPass = 0;
int openedPuts = 0, openedWasted = 0, outPuts = 0;
int altsFullEval = 0, altsScanned = 0;
int allPuts = 0;
...
class SuperDot3 {
  ...
  _Ways _first(First f, int pos) {
    ...
    _Way? out, opened;
    var nOpened = 0, nOut = 0, nFull = 0, nAlt = 0;
    firstCalls++;
