// m140.dart -- I79 UNGATED: the witness test applies to any way that repairs, not
// only one that OPENS with a repair, because `synth` sees only the opening.
// Generated by sed from m137.dart.
...
class SuperDot3 {
  ...
  ///
  /// I79: INVENTION MUST PAY FOR ITSELF IN EXPLANATION. I36 says synthesis must
  ...
  _Ways _first(First f, int pos) {
    ...
    for (final a in f.subClauses) {
      ...
      for (var e = _clause(a, pos); e != null; e = e.next) {
        // I79: INVENTION MUST PAY FOR ITSELF IN EXPLANATION.
        //
        ...
        if (e.cost > 0 && e.net <= e.cost) continue;
        out = _put(out, _cons(e, null));
      }
    }
    return _wrap(f, pos, out);
