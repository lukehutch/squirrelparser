...
class Squirrel {
  ...
  /// Fewer edits wins; among equals, the one that destroys less.
  ///
  /// r1 ordered deletions ahead of gaps outright, which was sound only while it
  /// had no gaps to trade against them: with the fill in hand that rule says any
  /// number of invented obligations is cheaper than deleting one character, and
  /// `[,2,33,true]` duly buys two fills rather than drop the stray comma. A
  /// skipped character and an unsupplied obligation are both one thing the input
  /// got wrong, so they count the same, and the old preference survives exactly
  /// where it was arguing from strength -- as the tie-break.
