// Scratch: fast smoke for m44 against m43 -- agreement on cost, tree and cover.
...
void main() {
  ...
  for (final s in cases) {
    ...
    final e44 = g44.SuperDot3(rules: rules, topRuleName: 'JSON');
    ...
    if (c43 != c44) {
      costDiff++;
      if (costDiff <= 8) print('COST  "$s"  m43=$c43 m44=$c44');
    }
    if (n43 != n44) {
      spanDiff++;
      if (spanDiff <= 8) print('SPANS "$s"  m43=$n43 m44=$n44');
    }
