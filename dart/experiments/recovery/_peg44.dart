// Scratch: the 5 peg_conformance cases, for m44 against m43 and m26. The
// PEG-vs-CFG reading is a documented flaw of the whole line (LESSONS 5b); this
// gate only has to establish that m44 adds no conformance regression.
...
void main() {
  ...
  for (final (name, g, top, s, truth) in cases) {
    ...
    final b = run(() => g43.SuperDot3(rules: r, topRuleName: top).recoverCost(s));
    final c = run(() => g44.SuperDot3(rules: r, topRuleName: top).recoverCost(s));
    if (a != c) diff++;
