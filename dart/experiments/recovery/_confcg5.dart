// The PEG-conformance gate, cgfr5's headline: the five cases where the CFG
...
// (null = none within 3). cgfr5 must be the first engine to match all five.
import 'package:squirrel_parser/squirrel_parser.dart';
import 'm62.dart' as a;
import 'cgfr5.dart' as b;
...
void main() {
  var ok = 0;
  print('case                truth   m62   cgfr5  verdict');
