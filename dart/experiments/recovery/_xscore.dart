...
import '_xnet.dart' as xnet;
import '_xgate.dart' as xgate;
import '_xterm.dart' as xterm;
import '_xa.dart' as xa;
import '_xb.dart' as xb;
import '_xc.dart' as xc;
import '_uni.dart' as uni;
import '_movedirty.dart' as movedirty;
import '_stopeoi.dart' as stopeoi;
import '_ab_give.dart' as abgive;
import '_ab_stop.dart' as abstop;
import '_ab_resync.dart' as abresync;
import '_ab_move.dart' as abmove;
...
final Map<String, Build> extra = {
  ...
  'r5': (r, t) => r5.Squirrel(rules: r, topRuleName: t).recover,
  'r6': (r, t) => r6.Squirrel(rules: r, topRuleName: t).recover,
  ...
  'xnet': (r, t) => xnet.Squirrel(rules: r, topRuleName: t).recover,
  'xgate': (r, t) => xgate.Squirrel(rules: r, topRuleName: t).recover,
  'xterm': (r, t) => xterm.Squirrel(rules: r, topRuleName: t).recover,
  ...
  'uni': (r, t) => uni.Squirrel(rules: r, topRuleName: t).recover,
  'movedirty': (r, t) => movedirty.Squirrel(rules: r, topRuleName: t).recover,
  'stopeoi': (r, t) => stopeoi.Squirrel(rules: r, topRuleName: t).recover,
  'abgive': (r, t) => abgive.Squirrel(rules: r, topRuleName: t).recover,
  'abstop': (r, t) => abstop.Squirrel(rules: r, topRuleName: t).recover,
  'abresync': (r, t) => abresync.Squirrel(rules: r, topRuleName: t).recover,
  'abmove': (r, t) => abmove.Squirrel(rules: r, topRuleName: t).recover,
};
