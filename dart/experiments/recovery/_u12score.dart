...
import '_u11.dart' as u11;
import '_u12.dart' as u12;
...
final variants = <String, Make>{
  ...
  'u11-nocell+residual': (r, t) => u11.Squirrel(rules: r, topRuleName: t).recover,
  'u12-u11+pred@0': (r, t) => u12.Squirrel(rules: r, topRuleName: t).recover,
};
