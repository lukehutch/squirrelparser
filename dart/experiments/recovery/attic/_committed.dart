...
final engines = <String, Run>{
  ...
  'r7': (r, t, s) => r7.Squirrel(rules: r, topRuleName: t).recover(s),
  'r8': (r, t, s) => r8.Squirrel(rules: r, topRuleName: t).recover(s),
  'r9': (r, t, s) => r9.Squirrel(rules: r, topRuleName: t).recover(s),
};
