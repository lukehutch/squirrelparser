// m100 -- I63 with the SWEPT repetition: m99's keys on m94's `_rep`.
//
...
_Way _cons(_Way w, _Way? next) => _Way(w.end, w.cost, w.got, w.net, w.synth,
    site: w.site, doubt: w.doubt, blind: w.blind,
  ...
  _Ways _wrap(Clause c, int pos, _Ways w) {
    ...
    for (var e = w; e != null; e = e.next) {
      out = _Way(e.end, e.cost, e.got, e.net, e.synth,
          site: e.site, doubt: e.doubt, blind: e.blind,
      ...
      out = _put(
          ...
          w != null
              ? _Way(pos, need, 0, 0, true,
                  site: 1, doubt: pos, leaf: Filled(sub, pos, w))
              : _Way(pos, need, 0, 0, true,
                  site: 1,
                  doubt: pos,
                  blind: 1,
