// m116.dart -- m113 with I54 removed and `blind` raised ABOVE cost -- no-invention as an absolute rule.
...
bool _better(
    ...
    b == null ||
    blind < b.blind ||
            (blind == b.blind && (cost < b.cost ||
            (cost == b.cost && (net > b.net ||
            (net == b.net && (got > b.got ||
...
class SuperDot3 {
  ...
  _Ways _repair(Clause sub, int pos) {
    ...
    if (need != null && need > 0 && need <= _budget) {
