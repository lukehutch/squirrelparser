// m113step.dart -- m113 with the doubling schedule replaced by step-by-one.
...
// vector that is not prefix-optimal, and _codexcx.dart shows it making the
// engine return a reading strictly worse under its own final objective.
// Generated by mk113.py.
...
class SuperDot3 {
  ...
  _Ways _repair(Clause sub, int pos) {
    ...
    if (need != null &&
        need > 0 &&
        need <= _budget &&
        (_witness(sub) != null || need < minSkip)) {
