// m118.dart -- m113 with `blind` raised to level 2 and I54 KEPT -- the cell that separates the ordering change from the prune removal.
// Generated by mkvar.py from m113.dart. Experiment only.
...
bool _better(
    ...
    b == null ||
    cost < b.cost ||
            (cost == b.cost && (blind < b.blind ||
            (blind == b.blind && (net > b.net ||
            (net == b.net && (got > b.got ||
            (got == b.got && (site < b.site ||
            (site == b.site && (doubt > b.doubt ||
            (doubt == b.doubt && (echo < b.echo))))))))))));
