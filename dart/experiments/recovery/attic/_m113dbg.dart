// m113dbg.dart -- m113 with the fill site instrumented. NOT an engine.
...
class SuperDot3 {
  ...
  _Ways _repair(Clause sub, int pos) {
    ...
    if (need != null && need > 0 && probe) {
      (sink ?? print)('FILL-SITE pos=$pos clause=${sub.runtimeType} '
          'need=$need minSkip=$minSkip witness=${_witness(sub) == null ? "NONE (blind)" : "\"${_witness(sub)}\""} '
          'I54-allows=${_witness(sub) != null || need < minSkip}');
    }
