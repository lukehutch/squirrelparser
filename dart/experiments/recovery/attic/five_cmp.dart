...
import 'm17.dart' as c;
import 'm18.dart' as d;
...
void main() {
  ...
  final r17 = c.SuperDot3(rules: rules, topRuleName: 'JSON');
  final r18 = d.SuperDot3(rules: rules, topRuleName: 'JSON');
  ...
  print('${'case'.padRight(13)}${'n'.padLeft(5)}${'cost'.padLeft(5)}'
      '${'v6'.padLeft(8)}${'m15'.padLeft(8)}${'m16'.padLeft(8)}'
      '${'m17'.padLeft(8)}${'m18'.padLeft(8)}'
      '${'m16/v6'.padLeft(9)}${'m17/v6'.padLeft(9)}${'m18/v6'.padLeft(9)}');
  var s6 = 0.0, s15 = 0.0, s16 = 0.0, s17 = 0.0, s18 = 0.0;
  for (final (label, m) in cases) {
    final t6 = best(() => r6.recover(m));
    final t15 = best(() => r15.recover(m));
    final t16 = best(() => r16.recover(m));
    final t17 = best(() => r17.recover(m));
    final t18 = best(() => r18.recover(m));
    if (r6.lastCost != r17.lastCost || r6.lastCost != r18.lastCost) {
      print('  COST DISAGREEMENT $label: v6=${r6.lastCost} '
          'm17=${r17.lastCost} m18=${r18.lastCost}');
    }
    s6 += t6;
    s15 += t15;
    s16 += t16;
    ...
    print('${label.padRight(13)}${m.length.toString().padLeft(5)}'
        ...
        '${t6.toStringAsFixed(1).padLeft(8)}${t15.toStringAsFixed(1).padLeft(8)}'
        '${t16.toStringAsFixed(1).padLeft(8)}${t17.toStringAsFixed(1).padLeft(8)}'
        '${t18.toStringAsFixed(1).padLeft(8)}'
        '${(t16 / t6).toStringAsFixed(2).padLeft(8)}x'
        '${(t17 / t6).toStringAsFixed(2).padLeft(8)}x'
        '${(t18 / t6).toStringAsFixed(2).padLeft(8)}x');
  }
  print('${'TOTAL'.padRight(23)}${s6.toStringAsFixed(1).padLeft(8)}'
      '${s15.toStringAsFixed(1).padLeft(8)}${s16.toStringAsFixed(1).padLeft(8)}'
      '${s17.toStringAsFixed(1).padLeft(8)}${s18.toStringAsFixed(1).padLeft(8)}'
      '${(s16 / s6).toStringAsFixed(2).padLeft(8)}x'
      '${(s17 / s6).toStringAsFixed(2).padLeft(8)}x'
      '${(s18 / s6).toStringAsFixed(2).padLeft(8)}x');
}
