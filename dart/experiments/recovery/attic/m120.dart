// m120.dart -- blind fills FORBIDDEN outright: only a fill whose clause
// determines its own text may be offered. Generated from m113.dart.
...
class SuperDot3 {
  ...
  _Ways _repair(Clause sub, int pos) {
    ...
    if (w != null && need != null && need > 0 && need <= _budget) {
      out = _put(
          out,
