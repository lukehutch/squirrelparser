// The PEG-conformance gate, m68's headline: the five cases where the CFG
...
// (null = none within 3). m68 must be the first engine to match all five.
import 'package:squirrel_parser/squirrel_parser.dart';
import 'm62.dart' as a;
import 'm68.dart' as b;
...
void main() {
  var ok = 0;
  print('case                truth   m62   m68  verdict');
