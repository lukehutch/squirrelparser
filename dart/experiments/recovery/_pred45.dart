// Scratch: does m45's "a gap attaches to the next terminal" rule lose repairs
...
void main() {
  ...
  for (final (title, grammar, top, alphabet, inputs) in cases) {
    ...
    final r43 = g44.SuperDot3(rules: rules, topRuleName: top);
    final r44 = g45.SuperDot3(rules: rules, topRuleName: top);
    print('\n$title   $grammar'.trim());
    print('${'input'.padRight(10)}${'true'.padLeft(6)}${'m44'.padLeft(6)}'
        '${'m45'.padLeft(6)}');
