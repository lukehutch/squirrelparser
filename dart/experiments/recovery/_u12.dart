...
class Squirrel {
  ...
  List<_Way> _expand(Clause c, int pos) {
    ...
    // AND AT BUDGET 0, WHICH IS WHAT THAT SENTENCE MEANS. Asking at the round's
    // budget builds every repaired reading of the predicate body only to throw
    // all of them away on `free`.
