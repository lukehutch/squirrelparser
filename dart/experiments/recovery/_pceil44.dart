// Scratch: does m44's DERIVED ceiling ever come up SHORT of a repair that m43
...
void main() {
  final cases = <(String, String, String, String)>[
    ...
    (
      'predicates that cannot pass, unrepairable',
      "S <- &'x' 'x' &'y' 'y';\n",
      'S',
      'zz',
    ),
  ...
  print('${'case'.padRight(46)}${'input'.padRight(6)} m43  m44'
      '   m43ms  m44ms');
