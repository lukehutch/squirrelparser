// Scratch: how does each engine scale in K? m44 wraps every terminal in a junk
// cell, so a terminal's end-map grows with the budget where m43's did not. This
// is the gate for whether that is a constant factor or an order. Same document
// and damage as _k39.dart so the numbers stay comparable. One engine per
// process, name on the command line.
import 'dart:math';
...
void main(List<String> args) {
  ...
  int Function(String) make() => switch (name) {
        ...
        'm43' => g43.SuperDot3(rules: rules, topRuleName: 'JSON').recoverCost,
        _ => g44.SuperDot3(rules: rules, topRuleName: 'JSON').recoverCost,
      };
  final d = doc(16);
  final out = <String>[];
