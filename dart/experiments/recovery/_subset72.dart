// Copy of _subset71.dart with m72 added: I29 must not move a single answer.
...
void main() {
  ...
  print('checked=$checked  m62wrong=$m62w  m70wrong=$m70w  m71wrong=$m71w  '
      'm72wrong=$m72w');
  print('m71 vs m72 cost DIFFERENCES = $diff   (I29 must give 0)');
