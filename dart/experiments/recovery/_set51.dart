...
class SuperDot3 {
  ...
  void _relax(_Cell cell) {
    ...
    //
    // m50 never cleared, and so a cell that was relaxed r times appeared in its
    // dependency's list r times: waking cost the sum over rounds instead of the
    // number of live readers, which is quadratic in the number of deepening rounds
    // and is where its `latms` went (the battery repairs cost 1-2 and hid it; the
    // 64-character latency cases do not).
