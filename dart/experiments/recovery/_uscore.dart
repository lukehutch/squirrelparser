...
import '_u2.dart' as u2;
import '_u3.dart' as u3;
import '_u4.dart' as u4;
import '_u5.dart' as u5;
import '_u0r.dart' as u0r;
import '_u3r.dart' as u3r;
import '_u6.dart' as u6;
import '_u7.dart' as u7;
import '_u8.dart' as u8;
...
final variants = <String, Make>{
  ...
  'u2-key-outranks-net': (r, t) => u2.Squirrel(rules: r, topRuleName: t).recover,
  'u3-no-del-break': (r, t) => u3.Squirrel(rules: r, topRuleName: t).recover,
  'u4-raw-not-del': (r, t) => u4.Squirrel(rules: r, topRuleName: t).recover,
  'u5-owed-marks': (r, t) => u5.Squirrel(rules: r, topRuleName: t).recover,
  'u0r-CONTROL-revord': (r, t) => u0r.Squirrel(rules: r, topRuleName: t).recover,
  'u3r-CONTROL-revord': (r, t) => u3r.Squirrel(rules: r, topRuleName: t).recover,
  'u6-del+gap-in-H': (r, t) => u6.Squirrel(rules: r, topRuleName: t).recover,
  'u7-u3+u5': (r, t) => u7.Squirrel(rules: r, topRuleName: t).recover,
  'u8-u7+owed>0': (r, t) => u8.Squirrel(rules: r, topRuleName: t).recover,
