...
class Squirrel {
  ...
  List<_Way> _seq(Seq c, int pos) {
    ...
    for (var i = 0; i < c.subClauses.length; i++) {
      ...
      // What this slot costs to give up, and what the rest of the production
      // costs to abandon, are properties of the GRAMMAR here -- not of the
      // prefix that arrives. So they are asked once for the slot rather than
      // once for every way that reaches it.
