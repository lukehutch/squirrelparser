// The PEG-conformance gate, m69's headline: the five cases where the CFG
...
// (null = none within 3). m69 must be the first engine to match all five.
import 'package:squirrel_parser/squirrel_parser.dart';
import 'm62.dart' as a;
import 'm69.dart' as b;
...
void main() {
  var ok = 0;
  print('case                truth   m62   m69  verdict');
