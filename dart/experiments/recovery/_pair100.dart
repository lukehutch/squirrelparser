// _pair100.dart -- m98 vs m100 (the swept repetition) interleaved within each case.
//
...
void main(List<String> argv) {
  ...
  for (var r = 0; r <= reps; r++) {
    ...
    print('pass $r${r == 0 ? ' (warm-up)' : ''}  m98 ${x.toStringAsFixed(0)} ms'
        '   m100 ${y.toStringAsFixed(0)} ms');
  }

  final ma = median(ta), mb = median(tb);
  print('');
  print('median of $reps passes');
  print('  m98  (site = maximal runs)      ${ma.toStringAsFixed(0)} ms');
  print('  m100  (sweep: one visit per end)   ${mb.toStringAsFixed(0)} ms'
