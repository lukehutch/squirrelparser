...
void main() {
  ...
  // --- Direct LR: E <- E '+n' / 'n' ---
  final directLRSimple = <String, Clause>{
    'E': First([
      Seq([Ref('E'), Str('+n')]),
      Str('n')
    ]),
  ...
  final indirectLRSimple = <String, Clause>{
    'E': First([Ref('F'), Str('n')]),
    'F': Seq([Ref('E'), Str('+n')]),
  };
  ...
  final directHiddenLR = <String, Clause>{
    'E': First([
  ...
  final indirectHiddenLR = <String, Clause>{
    'E': First([
  ...
  final multiStepLR = <String, Clause>{
    'E': First([
      Seq([Ref('F'), Str('+n')]),
      Str('n')
    ]),
  ...
  final interwovenLR = <String, Clause>{
    'L': First([
      Seq([Ref('P'), Str('.x')]),
      Str('x')
    ]),
  ...
  final interlockingLR = <String, Clause>{
    'E': First([
      Seq([Ref('F'), Str('n')]),
      Str('n')
    ]),
  ...
  test('LR-Recovery-trailing-plus', () {
    ...
    final parser = Parser(rules: directLRSimple, input: 'n+n+n+');
