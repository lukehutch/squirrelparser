...
public class EquationParser extends Parser {
	...
	public static final int
		NUM=1, OPEN=2, CLOSE=3, PLUS=4, MINUS=5, TIMES=6, DIV=7;
	public static final int
		RULE_eqn = 0, RULE_prec4 = 1, RULE_prec3 = 2, RULE_prec2 = 3, RULE_prec1 = 4, 
		RULE_prec0 = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"eqn", "prec4", "prec3", "prec2", "prec1", "prec0"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "NUM", "OPEN", "CLOSE", "PLUS", "MINUS", "TIMES", "DIV"
		};
	}
	...
	public static class EqnContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).enterEqn(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).exitEqn(this);
		}
	}
	...
	public static class Prec4Context extends ParserRuleContext {
		public TerminalNode OPEN() { return getToken(EquationParser.OPEN, 0); }
		public Prec0Context prec0() {
			return getRuleContext(Prec0Context.class,0);
		}
		public TerminalNode CLOSE() { return getToken(EquationParser.CLOSE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).enterPrec4(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).exitPrec4(this);
		}
	}
	...
	public static class Prec3Context extends ParserRuleContext {
		public TerminalNode NUM() { return getToken(EquationParser.NUM, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).enterPrec3(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).exitPrec3(this);
		}
	}
	...
	public static class Prec2Context extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).enterPrec2(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).exitPrec2(this);
		}
	}
	...
	public static class Prec1Context extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).enterPrec1(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).exitPrec1(this);
		}
	}
	...
	public static class Prec0Context extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_prec0; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).enterPrec0(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EquationListener ) ((EquationListener)listener).exitPrec0(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\2&\'\5\n\6\2\'*\3\2\2\2(*\5\n\6\2)$\3\2\2\2)(\3\2\2\2*\r\3\2\2\2\6"+
		"\26\33\")";
