...
public class MouseEqnParser extends mouse.runtime.ParserBase
{
  ...
  boolean Prec4()
    {
      begin("Prec4");
      if (!next('(') || !Prec0() || !next(')')) return reject();
      return accept();
    }
  ...
  boolean Prec3()
    {
      begin("Prec3");
      if (Prec3_0() || Prec4()) return accept();
      return reject();
    }
  ...
  boolean Prec2()
    {
      begin("Prec2");
      if (Prec2_0() || Prec3()) return accept();
      return reject();
    }
  ...
  boolean Prec2_0()
    {
      begin("Prec2_0");
      if (!next('-') || !Prec3()) return rejectInner();
      return acceptInner();
    }
  ...
  boolean Prec1()
    {
      begin("Prec1");
      if (Prec1_0() || Prec2()) return accept();
      return reject();
    }
  ...
  boolean Prec0()
    {
      begin("Prec0");
      if (Prec0_0() || Prec1()) return accept();
      return reject();
    }
